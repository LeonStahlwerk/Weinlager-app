...
def admin():
    ...
    if tab == "verwaltung":
        # Verwaltungstab kombiniert (aus beiden Dateien übernommen).
        pass

    elif tab == "statistik":
        # Statistik-Tab aus `app2.py`.
        pass

    elif tab == "weingueter":
        # Weingüter-Tab aus `app2.py`.
        pass

    return render_template_string("<h2>Tab nicht bekannt</h2>{{ tabs|safe }}", tabs=TAB_HTML)

@app.route("/edit/<barcode>", methods=["GET", "POST"])
def edit(barcode):
    # Bearbeiten-Funktion übernommen.
    pass

@app.route("/download/vorlage.csv")
def download_vorlage():
    # Download-Funktion aus `app.py`.
    pass
